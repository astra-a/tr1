...
export const chat = [
  {
    ...
    content: (
      <>
        <p>
          When do you release the coded for the Fleet - Travel kit? <br></br>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Hi @orval, thanks for contacting.<br></br>Yes, I’m working on it. It
          would be released next 2 weeks. You could check the progress here:
          <a href="ui8.net" target="_blank" rel="noreferrer">
