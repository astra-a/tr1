...
const Description = ({}) => (
  <div className="flex text-[1.125rem] font-medium leading-[1.75rem] max-lg:block">
    <div className="grow pr-16 max-xl:pr-10 max-lg:pr-0">
      <div className="mb-8 text-h4 max-md:mb-6 max-md:text-h5">Overview</div>
      <div className="[&_p,&_ul]:mb-7 [&_ul]:list-disc [&_ul]:pl-5 [&_a]:underline [&_a]:hover:no-underline [&_p:last-child,&_ul:last-child]:mb-0">
        <p>
          ...
          . Bento Pro Vol.2 builds upon our foundation of minimal design
          principles while <strong>introducing advanced compositions</strong>{" "}
          for modern digital experiences. This expanded collection maintains our
          signature clean aesthetic with seamless light and dark mode support,
          elevated by new, thoughtfully crafted components.
        </p>
        <p>
          We&apos;ve refined every detail to perfection, from enhanced gradient
          treatments to more sophisticated interactions. New dashboard layouts,
          expanded messaging interfaces, and innovative data visualizations
          provide even more tools for creating exceptional user experiences 🚀
        </p>
        <p className="!mb-0">
        ...
        <ul>
          ...
          <li>Post Management Systems</li>
        </ul>
        <p>
          Transform your design workflow with our most comprehensive release
          yet. Whether you&apos;re crafting fintech solutions, social platforms,
          or enterprise applications, Bento Pro Vol.2 delivers unmatched
          versatility with professional polish. 😎
        </p>
      </div>
    </div>
        ...
        <ul>
          {highlights.map((highlight) => (
            <li
              ...
              key={highlight}
            >
              <Icon className="mr-3 fill-t-primary" name="check-circle-fill" />{" "}
              {highlight}
            </li>
          ))}
        </ul>
        ...
        <div className="flex mt-8 border-t border-s-stroke2">
          <div className="flex-1 pt-8 pr-8 border-r border-s-stroke2 max-md:pt-6">
            <div className="flex items-center gap-2">
              ...
              <Icon className="!size-4 fill-t-primary" name="star-fill" />
            </div>
            <div>Ratings</div>
          </div>
