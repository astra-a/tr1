...
import ShopItem from "@/app/dashboard/_components/ShopItem";
import Follower from "@/app/dashboard/_components/Follower";
import Spinner from "@/app/dashboard/_components/Spinner";
import Profile from "./Profile";

import { shopItems } from "@/app/dashboard/_mocks/shopItems";
import { followers } from "@/app/dashboard/_mocks/followers";
import { followings } from "@/app/dashboard/_mocks/followings";
    ...
    <Layout hideSidebar>
      <div className="">
        <Image
          ...
          src="/images/dashboard/shop-banner.png"
          width={1880}
          height={510}
          alt="shop-banner"
          priority={true}
