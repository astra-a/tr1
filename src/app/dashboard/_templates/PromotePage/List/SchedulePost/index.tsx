...
import DateAndTime from "@/app/dashboard/_components/DateAndTime";
        ...
        <div className="flex items-start mt-6 max-md:mt-3">
          <div className="shrink-0">
            <Image
              ...
              src="/images/dashboard/posts/2.png"
              width={80}
              height={80}
              alt="Post"
            />
          ...
          <div className="flex grow pl-6 max-md:block max-md:pl-4">
            <div className="text-body-2 line-clamp-3 max-md:line-clamp-2">
              Excited to announce the launch of Core Dashboard 2.0 on the UI8
              marketplace! This UI Design Kit is packed with sleek components
              and modern layouts to elevate your projects.
            </div>
