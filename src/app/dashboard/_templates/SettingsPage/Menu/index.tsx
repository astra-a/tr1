...
const Menu = ({ user, profileInformationTo, items }: MenuProps) => {
  const isOnline = true;
    ...
    <div className="card sticky top-22 shrink-0 w-120 max-3xl:w-100 max-2xl:w-74 max-lg:hidden">
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          ...
          <div className="relative z-2 flex justify-center items-center shrink-0 w-11 h-11 bg-b-surface1">
            <Jdenticon size={44} value={user.email} />
            {/*{isOnline && (*/}
          ...
          <div className="relative z-2 grow pl-4">
            <div className="text-button">Admin</div>
