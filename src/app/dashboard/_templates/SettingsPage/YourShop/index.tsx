...
import FieldImage from "@/app/dashboard/_components/FieldImage";
...
const customizeProfileOptions = [
  { id: 1, name: "Recent post first" },
  { id: 2, name: "Oldest post first" },
  { id: 3, name: "Random" },
];
    ...
    <Card title="Your shop">
      <div className="flex flex-col gap-8 p-5 pt-0 max-lg:px-3 max-md:gap-4">
        <FieldImage
          ...
          initialImage="/images/dashboard/shop-banner.png"
        />
