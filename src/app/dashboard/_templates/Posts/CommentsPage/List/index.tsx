...
import { Comment } from "@/app/dashboard/_types/comment";

const tableHead = ["Comment", "Post"];
            ...
            >
              ...
              <div className="w-[calc(100%-3rem)] pl-5">
                <div className="flex items-center flex-wrap">
                  <div className="text-sub-title-1">{item.author}</div>
          ...
          <td className="w-124 max-[1529px]:w-93 max-lg:hidden">
            <div className="relative">
              <div className="inline-flex items-center transition-all group-hover:invisible group-hover:opacity-0">
                ...
                <div className="pl-5">
                  <div className="pr-6 text-sub-title-1">{item.title}</div>
