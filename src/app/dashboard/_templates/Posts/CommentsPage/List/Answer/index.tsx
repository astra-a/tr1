...
import LikeButton from "@/app/dashboard/_components/LikeButton";
  ...
  <div className="relative flex mt-4 before:absolute before:-left-11.5 before:-top-3.5 before:w-8.5 before:h-8 before:border-l before:border-b before:border-s-stroke2 before:rounded-bl-[0.625rem]">
    <div className="shrink-0">
      <Image
        ...
        src="/images/dashboard/avatars/4.png"
        width={32}
        height={32}
        alt=""
      />
    ...
    <div className="w-[calc(100%-2rem)] pl-4">
      <div className="flex items-center">
        ...
        <div className="ml-3 text-body-2 text-t-secondary/80">@dash</div>
      ...
      <div className="text-t-primary/80">
        Hey @samstoo! 😊 We&apos;re working on cool stuff in the cybersecurity
        space. Stay tuned, and thanks for the awesome idea! 🔍✨
      </div>
