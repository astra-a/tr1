...
const DraftsPage = ({
  ...
  const handleBatchOperate = async (operate: "publish" | "delete") => {
    try {
        ...
        {selectedRows.length === 0 ? (
          <div className="flex items-center">
            ...
            <Search
              ...
              onChange={(e) => {
                ...
                router.push(ROUTES.posts_drafts(e.target.value));
              }}
          ...
          <div className="flex items-center">
            ...
            <Button
              className="ml-2"
              isBlack
              onClick={() => handleBatchOperate("publish")}
            >
              Publish
            </Button>
          </div>
          ...
          <div className="p-1 pt-3 max-lg:px-0">
            ...
            {PAGE_SIZE < postCount && (
              <Pagination
                ...
                currentPage={page}
                onPageChange={(_page) => {
                  router.push(ROUTES.posts_drafts(search, _page));
                }}
              />
            )}
          </div>
