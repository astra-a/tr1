...
import { payoutHistory } from "@/app/dashboard/_mocks/payouts";
...
const PayoutHistory = () => {
  ...
  return (
    <div className="card">
      ...
      {search !== "" ? (
        <NoFound title="No payouts found" collectionName="" />
      ) : (
          ...
          >
            {payoutHistory.map((transaction) => (
              <TableRow key={transaction.id}>
                <td className="max-md:text-caption">{transaction.date}</td>
                <td>
                  <div
                      ...
                      <Image
                        ...
                        src={
                          transaction.method === "stripe"
                            ? "/images/dashboard/logos/stripe.svg"
                            : "/images/dashboard/logos/paypal.svg"
                        }
