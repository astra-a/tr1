...
import { messagesCustomers } from "@/app/dashboard/_mocks/messages";
  ...
  return (
    <Card classHead="!pl-3" title="Messages">
          ...
          >
            ...
            <div className="relative z-2 grow pl-5">
              <div className="mb-1 text-sub-title-1">
                {message.name}
                &nbsp;
                <span className="text-t-secondary">@{message.login}</span>
              </div>
      ...
      <div className="pt-6 px-3 pb-3">
        <Button className="w-full" href={ROUTES.messages} as="link" isStroke>
          View all message
        </Button>
      </div>
    </Card>
