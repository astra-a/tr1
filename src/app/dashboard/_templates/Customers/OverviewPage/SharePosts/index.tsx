...
import { postsShare } from "@/app/dashboard/_mocks/posts";
  ...
  return (
    <Card title="Share posts">
      ...
      <div className="mb-6 px-5 text-body-2 text-t-secondary max-lg:px-3 max-md:text-caption">
        Fifty percent of new customers explore posts because the author shares
        their work on social media. <br></br>Start earning now! 🔥
      </div>
