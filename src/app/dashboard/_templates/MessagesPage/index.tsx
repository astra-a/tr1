...
import { messages } from "@/app/dashboard/_mocks/messages";
        ...
        <div className="flex max-md:block max-md:p-3">
          <div
            className={`shrink-0 w-126 max-4xl:w-106 max-3xl:w-96 p-3 pb-0 max-2xl:w-76 max-md:w-full max-md:p-0 ${
              activeMessage === null ? "max-md:block" : "max-md:hidden"
            }`}
          >
            <Search
              className="mb-3"
            ...
            {search === "" ? (
              ...
              <div className="pt-16 text-center max-md:pb-24">
                <div className="mb-6 text-h5">No results found</div>
                <Button isStroke as="link" href={ROUTES.exploreCreators}>
                  Explore creators
                </Button>
              </div>
            )}
