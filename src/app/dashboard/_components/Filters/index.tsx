...
import Range from "@/app/dashboard/_components/Range";
import Compatibility from "@/app/dashboard/_components/Compatibility";
...
const Filters = ({}) => {
  ...
  const [featuredPosts, setFeaturedPosts] = useState(true);
        ...
        <div className="flex items-center justify-between mt-13 max-md:block max-md:mt-6">
          <div className="flex items-center gap-4 max-md:w-full max-md:h-12 max-md:mb-3">
            <div className="flex items-center max-md:mr-auto">
              <div className="text-button">Featured posts</div>
              <Tooltip
                className="ml-1.5"
            ...
            <Switch
              checked={featuredPosts}
              onChange={() => setFeaturedPosts(!featuredPosts)}
            />
          </div>
