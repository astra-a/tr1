          ...
          <li key={j}>
            <div className="flex flex-nowrap justify-center items-center w-min relative">
              {FEATURES.map((item, i) => (
                <div
                  key={i}
                  className="flex w-62 sm:w-66 md:w-68 lg:w-72 xl:w-84 2xl:w-90 3xl:w-100 justify-center items-center gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 3xl:px-14 py-4 md:py-5 lg:py-6 xl:py-7 feature-box"
                >
                  <Image
                    src={item.icon}
                    alt=""
