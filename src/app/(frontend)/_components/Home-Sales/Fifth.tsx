  ...
  return (
    <div className="w-full h-full z-[0] morphing-particles-container overflow-hidden pointer-events-none">
      <video
        ...
        poster={`${CDN_BASEURL}/images/bg-sales-${width >= 768 ? "" : "mobile-"}fifth-1-poster.png`}
        onEnded={() => {
          if ("intro" === phase) {
            onEnded?.();
            setPhase("loop");
      ...
      >
        <source
          src={`${CDN_BASEURL}/images/bg-sales-mobile-fifth-1.mp4`}
          type="video/mp4"
      ...
      <video
        ...
        poster={`${CDN_BASEURL}/images/bg-sales-${width >= 768 ? "" : "mobile-"}fifth-2-poster.png`}
      >
        <source
          src={`${CDN_BASEURL}/images/bg-sales-mobile-fifth-2.mp4`}
          type="video/mp4"
          media="(max-width: 767px)"
        />
        <source
