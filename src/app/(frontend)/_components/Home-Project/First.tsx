    ...
    >
      <div className="relative w-full h-full flex justify-center">
        <VideoBackground
          videos={{
            mobile: {
              url: `${CDN_BASEURL}/images/bg-project-mobile-first.mp4`,
              poster: `${CDN_BASEURL}/images/bg-project-mobile-first-poster.png`,
              width: 680,
              height: 1024,
            },
            desktop: {
              url: `${CDN_BASEURL}/images/bg-project-first.mp4`,
              poster: `${CDN_BASEURL}/images/bg-project-first-poster.png`,
              width: 1920,
              height: 1080,
            },
          }}
